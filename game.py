...
class Game:
    ...
    def auto_move(self):
        ...
        # strategy = get_move(self.level.structure[:-1], self.level.position_player, 'astar_manhattan')
        strategy = get_move(self.level.structure[:-1], self.level.position_player, 'astar_euclidean')
